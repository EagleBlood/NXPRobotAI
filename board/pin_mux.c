...
void BOARD_InitMotor(void)
{
    ...
    GPIO_PinInit(BOARD_INITMOTOR_AIN2_GPIO, BOARD_INITMOTOR_AIN2_PIN, &AIN2_config);
    ...
    GPIO_PinInit(BOARD_INITMOTOR_AIN1_GPIO, BOARD_INITMOTOR_AIN1_PIN, &AIN1_config);
    ...
    GPIO_PinInit(BOARD_INITMOTOR_BIN1_GPIO, BOARD_INITMOTOR_BIN1_PIN, &BIN1_config);
    ...
    GPIO_PinInit(BOARD_INITMOTOR_BIN2_GPIO, BOARD_INITMOTOR_BIN2_PIN, &BIN2_config);

    /* PORT1_22 (pin L4) is configured as PIO1_22 */
    PORT_SetPinMux(BOARD_INITMOTOR_AIN2_PORT, BOARD_INITMOTOR_AIN2_PIN, kPORT_MuxAlt0);
    ...
    PORT_SetPinMux(BOARD_INITMOTOR_AIN1_PORT, BOARD_INITMOTOR_AIN1_PIN, kPORT_MuxAlt0);
    ...
    PORT_SetPinMux(BOARD_INITMOTOR_BIN1_PORT, BOARD_INITMOTOR_BIN1_PIN, kPORT_MuxAlt0);
    ...
    PORT_SetPinMux(BOARD_INITMOTOR_BIN2_PORT, BOARD_INITMOTOR_BIN2_PIN, kPORT_MuxAlt0);
    ...
    /* PORT4_12 (pin T6) is configured as CT4_MAT0 */
    PORT_SetPinMux(BOARD_INITMOTOR_PWMA_PORT, BOARD_INITMOTOR_PWMA_PIN, kPORT_MuxAlt4);
    ...
    /* PORT4_13 (pin T7) is configured as CT4_MAT1 */
    PORT_SetPinMux(BOARD_INITMOTOR_PWMB_PORT, BOARD_INITMOTOR_PWMB_PIN, kPORT_MuxAlt4);
